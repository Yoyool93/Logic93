<div class="content p-5" style="width: 40%">
    ...
    <form class="form mt-4" method="POST" action="<?= BASE_DIR ?>/utilisateurs/signup">
        ...
        <div class="form-group mb-4">
            <label for="inputPrenom" class="text-right">Prenom</label>
            <input required maxlength="250" type="text" class="form-control mt-2" id="inputPrenom" name="PrenomUser" placeholder="Entrez votre prenom">
        </div>
        ...
        <div class="form-group mb-4">
            <label for="inputAdresse" class="text-right">Adresse</label>
            <input required maxlength="250" type="text" class="form-control mt-2" id="inputAdresse" name="AdresseUser" placeholder="Entrez votre adresse">
        </div>
        <div class="form-group mb-4">
            <div class="input-group">
                <label for="inputVille" class="text-right">Ville</label>
                <input required type="texte" class="form-control mt-2" id="inputVille" name="VilleUser" placeholder="Entrez votre ville ">
                <label for="inputCP" class="text-right">Code postal</label>
                <input required min="0"  type="number" class="form-control mt-2" id="inputCP" name="CPUser" placeholder="Entrez votre Code postal">
            </div>
        </div>
